            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                       ...
                       <div class="form-group row">
                            <label for="url_status1"
                                   class="col-sm-2 form-control-label">Button URL</label>
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('url_status','1',($WebmasterSections->url_status==1) ? true : false, array('id' => 'url_status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ __('backend.yes') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('url_status','0',($WebmasterSections->url_status==0) ? true : false, array('id' => 'url_status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ __('backend.no') }}
                                    </label>
                                </div>
                         ...
                         <div class="form-group row">
                            <label for="whatsap_status1"
                                   class="col-sm-2 form-control-label">Whatsapp No</label>
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('whatsap_status','1',($WebmasterSections->whatsap_status==1) ? true : false, array('id' => 'whatsap_status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ __('backend.yes') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('whatsap_status','0',($WebmasterSections->whatsap_status==0) ? true : false, array('id' => 'whatsap_status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ __('backend.no') }}
                                    </label>
                                </div>
