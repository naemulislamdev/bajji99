                        ...
                        @if($Topics->total() > 0)
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    @endif
                                        @if($WebmasterSection->url_status || $WebmasterSection->whatsap_status)
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                             ...
                                             @if($WebmasterSection->url_status || $WebmasterSection->whatsap_status)
                                                ...
                                                <a href="{!! $Topic->url_link !!}" target="__blank"
                                                  >  <img src="{{ URL::to('uploads/media/fb_m.svg') }}" width="40px"
                                                         alt="{!! $Topic->url_link !!}"/> </a>
                                                          <a href="https://wa.me/{!! $Topic->whatsap_no !!}" target="__blank"
                                                  >  <img src="{{ URL::to('uploads/media/wpapp.svg') }}" width="40px"
                                                         alt="{!! $Topic->whatsap_no !!}"/> </a>
                                                </td>
                                            @endif
